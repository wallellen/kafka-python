...
class TestKafkaProducerIntegration(KafkaIntegrationTestCase):
    ...
    def test_produce_many_simple(self):
        ...
        self.assert_produce_request(
            [ create_message(py3.b("Test message %d" % i)) for i in range(100) ],
            start_offset,
            100,
        )
    ...
    def test_produce_10k_simple(self):
        ...
        self.assert_produce_request(
            [ create_message(py3.b("Test message %d" % i)) for i in range(10000) ],
            start_offset,
            10000,
        )
    ...
    def test_produce_many_gzip(self):
        ...
        message1 = create_gzip_message([py3.b("Gzipped 1 %d" % i) for i in range(100)])
        message2 = create_gzip_message([py3.b("Gzipped 2 %d" % i) for i in range(100)])
    ...
    def test_produce_mixed(self):
        ...
        msg_count = 1+100
        messages = [
            create_message(py3.b("Just a plain message")),
            create_gzip_message([py3.b("Gzipped %d" % i) for i in range(100)]),
        ]
    ...
    def test_produce_100k_gzipped(self):
        ...
        self.assert_produce_request([
                create_gzip_message([py3.b("Gzipped batch 1, message %d" % i) for i in range(50000)])
            ],
            start_offset,
            50000,
        )
